...
RESOURCES += src/qt/zinni.qrc src/qt/zinni_locale.qrc

TRANSLATIONS += src/qt/locale/zinni_bg.ts \
                src/qt/locale/zinni_de.ts \
                src/qt/locale/zinni_en.ts \
                src/qt/locale/zinni_es.ts \
                src/qt/locale/zinni_fi.ts \
                src/qt/locale/zinni_fr.ts \
                src/qt/locale/zinni_it.ts \
                src/qt/locale/zinni_ja.ts \
                src/qt/locale/zinni_pl.ts \
                src/qt/locale/zinni_pt.ts \
                src/qt/locale/zinni_ru.ts \
                src/qt/locale/zinni_sk.ts \
                src/qt/locale/zinni_sv.ts \
                src/qt/locale/zinni_vi.ts \
                src/qt/locale/zinni_zh_CN.ts \
                src/qt/locale/zinni_zh_TW.ts
