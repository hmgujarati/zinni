...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ZIN features */
        {"zinni", "masternode", &masternode, true, true, false},
        {"zinni", "masternodelist", &masternodelist, true, true, false},
        {"zinni", "mnbudget", &mnbudget, true, true, false},
        {"zinni", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"zinni", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zinni", "mnsync", &mnsync, true, true, false},
        {"zinni", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"zinni", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zinnid, or the -server option to zinni-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Zinni Alert\" admin@foo.com\n"),
...
{
    return "> zinni-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9277/\n";
}
