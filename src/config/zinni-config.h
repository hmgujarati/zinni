/* src/config/zinni-config.h.  Generated from zinni-config.h.in by configure.  */
/* src/config/zinni-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://zinni.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Zinni Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Zinni Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "zinni"
