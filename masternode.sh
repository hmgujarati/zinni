...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='zinni.conf'
CONFIGFOLDER='/root/.zinni'
COIN_DAEMON='zinnid'
COIN_CLI='zinni-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/ZinniCoin/zinni.git'
COIN_TGZ='https://github.com/ZinniCoin/zinni/releases/download/v1.0.3.0/zinni-ubuntu-binaries.tgz'
